//var Bci = require('./bci');
var SampDb = require('../middleware/db/sampChunk');
...
var OpenBCI = function (options) {
    ...
    this.close = function (cb) {
        // Ensure the stream is not running
        board.streamStop()
            .then(function () {
                board.disconnect();
                cb(null);
